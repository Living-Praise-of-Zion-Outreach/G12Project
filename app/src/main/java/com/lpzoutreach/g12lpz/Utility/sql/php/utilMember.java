...
public class utilMember {
    ...
    public static void do_get_church_list_members(Context context, ListView lv, String churchID, String name, elUtil event){
    ...
    public static void do_get_who_invite_list_members(Context context, ListView lv, String churchID, String name, elUtil event){
        RequestQueue MyRequestQueue = Volley.newRequestQueue(context);
        String url = accessUrl.BASE_URL +  "android/profile/search-who-invite"; // <----enter your post url here
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, url,
                response -> {
