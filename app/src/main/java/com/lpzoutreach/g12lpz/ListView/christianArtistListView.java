...
public class christianArtistListView extends ArrayAdapter<ChristianArtistModel> {
    private Context context;
    private List<ChristianArtistModel> data;
    private int id;

    public christianArtistListView(Context context, int id, List<ChristianArtistModel> data){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                rows.getEventListenerUtil().myCallBack("list-view", rows.getArtist_id().toString());
            }
        });
        ...
        card.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                rows.getEventListenerUtil().myCallBack("list-view-delete", rows.getArtist_id().toString());
                return false;
            }
        });
